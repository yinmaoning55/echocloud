...
function(b, f) {
    ...
    b.jPlayer.prototype = {
        ...
        _updateInterface: function() {
            ...
            250, "linear") : this.css.jq.playBar.width(this.status.currentPercentRelative + "%") && $("#progreeBar a").css("left",this.status.currentPercentRelative+"%"));
            var a = "";
        ...
        _seeking: function() {
			...
			$('#progreeBar a').addClass("ui-slider-handle-loading");
        },
        _seeked: function() {
            //this.css.jq.seekBar.length && this.css.jq.seekBar.removeClass("jp-seeking-bg")
			$('#progreeBar a').removeClass("ui-slider-handle-loading");
        },
        _resetGate: function() {

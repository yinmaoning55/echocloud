...
function serch()
{
   document.info.action="page_listMyplays.action";
      ...
      <div class="leftbar-bottom-bg">
        <div class="leftbar-outer">
           <div class="leftbar">
            ...
            <div class="list list-history selected" id="list_often"> <a  class="icon column1-icon list-history-icon" hidefocus="true"></a> <a class="text" href="page_listMyplays.action">播放记录</a> <a  class="column1-icon listening-icon" hidefocus="true"></a> </div>
								...
								<div class="playlist-length" style="width:480px">
									...
									<div>
									  <%--<div style="width:220px;float:left;">--%>
										   <%--<form name="info" id="info" action="page_listMyplays.action" method="post" style="width:100%;height:100%">--%>
										   <%--<input type="hidden" name="pageNo" id="pageNo" value="${paperUtil.pageNo}"/>--%>
									   	   <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
									       <%--<input type="text" name="all_name" id="all_name" value="${paramsMyplay.all_name}" class="inputstyle"/>&nbsp;--%>
...
(function(){
        ...
        //初始化音乐
        <c:forEach items="${myplays}" var="music" varStatus="status">
		var musicData = {
		 	id:"${music.music_id}",

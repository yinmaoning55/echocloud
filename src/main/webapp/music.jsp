    ...
    <div class="mb-layout-bd column1" id="leftCol">
      <div class="leftbar-bottom-bg">
        <div class="leftbar-outer">
          <div class="leftbar">
            <div class="list list-most selected" id="list_late"> <a  class="icon column1-icon list-most-icon" hidefocus="true"></a> <a class="text" href="page_listMusics.action">所有歌曲</a> <a  class="listening-icon" hidefocus="true"></a> </div>
            ...
            <div class="list">　&nbsp;&nbsp; &nbsp;&nbsp;<i class="layui-icon layui-icon-shrink-right" style="font-size: 15px; color: #14160e;"></i><a class="text" href="page_listMycollects.action?mysheet_id=${mysheet.mysheet_id}">${mysheet.mysheet_name}</a> <a class="column1-icon listening-icon" hidefocus="true"></a> </div>
          	</c:forEach>
          </div>
        </div>
      </div>
    ...
    <div class="mb-layout-bd column3" id="lrcCol" style=" right: 0px;">
      ...
      <div class="link-wrapper">
        ...
        <div class="clipboard-wrapper">
		    <a id="downloadLrc" class="clip-btn"  target="_blank">查看評論</a>
			      ...
			      <div id="page-song" class="tab-page reelList_274789 ui-reelList ui-widget ui-tabs-panel ui-widget-content ui-corner-bottom fullHeartShow" style="top: 0px;">
					   ...
					   <div class="ui-reelList-header ui-state-default">
						...
						<div class="ui-reelList-viewport">
						  ...
						  <div class="ui-reelList-centerLoading"></div>
						</div>
						<!-- 中间结束 -->
						<!-- 底部开始 -->
...
<table id="hbzj_con" class="layui-table" width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <c:forEach items="${mysheets}" var="mysheet" varStatus="status">
   <tr class="list0">

...
<table width="190" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
  	<td height="23" style="text-align:center; line-height:23px; color:white; background-color:#acddb4;font-weight:bold">功能模块管理</td>
  </tr>
  <tr>
			 ...
			 <table width="100%" height="280" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEF2FB">
			  <tr>
				...
				<div id="container">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">歌曲信息管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listMusics.action" target="MainFrame">歌曲信息查询</a></li>
					  <li><a href="Admin_addMusicShow.action" target="MainFrame">新增歌曲信息</a></li>
					</ul>
				  </div>
				  </c:if>

...
<div class="top">
	<div class="top1">
    	<div class="logo" style="margin-top:10px;font-size:36px;font-weight:bold;color:#48bb86">
			echo云音乐管理系统后台
		</div>
        <div class="top_info" style="margin-top:40px">
        	当前登录用户：${admin.user_typeDesc} ${admin.real_name}
        	&nbsp;&nbsp;&nbsp;&nbsp;<a id="logOut" href="#" style="color:#e8f0c0">→退出系统←</a>
        </div>
    </div>
</div>
</body>

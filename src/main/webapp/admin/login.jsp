...
<BODY style="background:url('images/Vinyl_wall.png')">
...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
	<TBODY>
		<TR>
			<TD style="text-align:center;HEIGHT:105px;font-size:38px;font-family:'layui-icon';color:#14160e">
					echo云音乐管理系统后台
			</TD>
		</TR>
		<TR>
				...
				<TR>
					...
					<TBODY>
						<TR>
							...
							<TD style="HEIGHT: 28px" width=150><INPUT id="user_name" name="user_name" value="${params.user_name}" class="layui-input" name=txtName></TD>
						...
						<TR>
							...
							<TD style="HEIGHT: 28px"><INPUT id="user_pass" name="user_pass"  class="layui-input" style="WIDTH: 170px"
							  type="password"></TD>
						...
						<TR>
							...
							<TD style="HEIGHT: 28px">
								<INPUT id="random" name="random" style="WIDTH: 70px" name=txtcode>
								<img src="Random.jsp" width="70" valign="middle" style="cursor:pointer;vertical-align:middle" title="换一张" id="safecode" border="0" onClick="reloadcode()"/>
							</TD>
							<TD style="HEIGHT: 28px">
						...
						<TR>
							<TD></TD>
							<TD colspan="2"><img id="loginInBtn"  style="border:0px;cursor:pointer" src="../images/but.svg" /> </TD>
						</TR>
					</TBODY>
					</TABLE>
					</TD>

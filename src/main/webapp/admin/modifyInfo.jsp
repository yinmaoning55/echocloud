...
$(document).ready(function(){
	 ...
	 var num = /^\d+$/;
	 var user_type = "${admin.user_type}";
	 $("#saveBtn").bind('click',function(){
		if(user_type!="1" && $("#real_name").val()==''){
			alert('姓名不能为空');
			return;
		}
		$("#info").submit();
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">个人信息中心&gt;&gt;编辑个人信息</span>
</div>
       ...
       <table width="100%" align="center" cellpadding="0" cellspacing="0" class="editbody">
        <tr class="editbody">
          <td align="center" height="30">
            <input type="button" id="saveBtn" class="layui-btn layui-btn-radius" value="编 辑"/>
          </td>
        </tr>
      </table>
     </td>

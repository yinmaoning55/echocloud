...
<body onload="setIframeWH()" style="margin:0px; padding:0px; background:#48bb86;">
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    <td colspan="5" height="73">
		<iframe width="100%" style="margin:0px; padding:0px;" height="73" scrolling="no" src="top.jsp" frameborder="0"></iframe>
	</td>
  </tr>

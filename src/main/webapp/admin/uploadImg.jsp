...
<br/>
<span id="upTip" style="color:#f00a0c"></span>
</form>
...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("pic_name");
    ...
    window.parent.document.getElementById("userImg").src="images/datas/"+filename;
  }
  else if(flag=='no')
  {
    window.parent.document.getElementById("op").style.display="none";

...
<html>
	<head>
		...
		<meta name="Description" content="echo音乐网.">
		<title>echo云音乐</title>
			...
			<div class="b_focus">
				<ul class="b-img">
					<li>
						...
						<div class="i-desc1">
							<h2>回忆中的BigBang</h2>
							<p style="font-size:22px;">BigBang那些经典</p>
						</div>
					</li>
					<li>
...
<script type="text/javascript" src="<%=path %>/js/audioface.js"></script>
...
<script type="text/javascript">
	...
	function changeCheckCode(){
		var src = "<%=path %>/user/code?data="+new Date();
